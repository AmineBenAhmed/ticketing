...
declare global {
  namespace NodeJS {
    interface Global {
      signin(id?: string): string[] //the signin functon that is going to return a value of type array of string
    }
  }
}
...
process.env.STRIPE_KEY = 'sk_test_51HpfM1BZZcOeUTELB5ORJeBx1PrjLd52hn8vhoANBu8i2849Y1WabZpRhjmIwcO9oJKeRoejZ5Gz9INMh2QrHBa4007IPuS221'
